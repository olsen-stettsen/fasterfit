...
function setrecs(){
    ...
    document.getElementById("datadisplay3").innerHTML = document.getElementById("datadisplay3").innerHTML.replace("\"","").replace("\"","").replace(/hhhh/g, "<h4>").replace(/hhhj/g, "</h4>").replace("&lt;p&gt;", "<p>").replace("&lt;/p&gt;", "</p>").replace("&lt;br&gt;", "<br>");
    /*
