...
function setrecs(){
    ...
    document.getElementById("datadisplay3").innerHTML = document.getElementById("datadisplay3").innerHTML.replace("\"","").replace("\"","").replace("&lt;h4&gt;", "<h4>").replace("&lt;/h4&gt;", "</h4>").replace("&lt;p&gt;", "<p>").replace("&lt;/p&gt;", "</p>");
    /*
